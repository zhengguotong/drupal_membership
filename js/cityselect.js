...
(function($){
	$.fn.citySelect=function(settings){
		...
		var townStart=function(){
			...
			if(prov_id<0||city_id<0 || dist_id < 0||typeof(city_json.citylist[prov_id].c[city_id].a[dist_id].t)=="undefined"){
				if(settings.nodata=="none"){
			...
			// 遍历赋值市级下拉列表
			temp_html=select_prehtml;
			$.each(city_json.citylist[prov_id].c[city_id].a[dist_id].t,function(i,town){
				temp_html+="<option value='"+town.m+"'>"+town.m+"</option>";
			});
